...
const SilNotes = () => {
  ...
  const match = useMatch('/sil-notes');
  ...
  return (
    <div className="w-full max-w-screen-lg mx-auto flex flex-col ">
      ...
      <Typography variant="h3" component="div" className={`py-5 text-psl-primary dark:text-psl-active-text`}>SIL Notes</Typography>
      <GeneralDataGrid
