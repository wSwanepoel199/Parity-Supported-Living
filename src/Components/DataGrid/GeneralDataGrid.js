...
const CustomLinearProgression = () => {
  return (
    <LinearProgress
      className={`bg-psl-primary-text dark:bg-psl-secondary`}
  ...
  return (
    <DataGrid
      ...
      classes={{
        ...
        columnHeader:
          "border-0 border-x-[1px] border-solid first:border-l-0 last:border-r-0 border-psl-primary-text/40 dark:border-psl-secondary-text/40 max-h-8 px-2",
        withBorderColor:
          "border-psl-primary-text/30 dark:border-psl-secondary-text/30",
        cell: "text-psl-primary dark:text-psl-secondary-text",
        columnHeaderTitleContainerContent:
          "text-psl-primary dark:text-psl-secondary-text",
